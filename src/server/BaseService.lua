...
local CARD_FRAME_ASSET_TINTS = {
	["Gold"] = {
		base = Color3.fromRGB(172, 103, 28),
		glow = Color3.fromRGB(255, 205, 82),
		panel = Color3.fromRGB(86, 52, 14),
		accent = Color3.fromRGB(255, 214, 105),
		silhouette = Color3.fromRGB(20, 14, 9),
		washTransparency = 0.18,
		panelTransparency = 0.08,
		glowTransparency = 0.34,
		stripTransparency = 0.03,
	},
	["Rare Gold"] = {
		base = Color3.fromRGB(210, 66, 20),
		glow = Color3.fromRGB(255, 132, 42),
		panel = Color3.fromRGB(84, 22, 7),
		accent = Color3.fromRGB(255, 174, 55),
		silhouette = Color3.fromRGB(25, 8, 4),
		washTransparency = 0.14,
		panelTransparency = 0.06,
		glowTransparency = 0.28,
		stripTransparency = 0.02,
	},
	["Premium Gold"] = {
		base = Color3.fromRGB(232, 166, 28),
		glow = Color3.fromRGB(255, 242, 124),
		panel = Color3.fromRGB(92, 58, 8),
		accent = Color3.fromRGB(255, 228, 112),
		silhouette = Color3.fromRGB(20, 14, 4),
		washTransparency = 0.12,
		panelTransparency = 0.05,
		glowTransparency = 0.24,
		stripTransparency = 0.02,
	},
	["Talisman"] = {
		base = Color3.fromRGB(116, 48, 196),
		glow = Color3.fromRGB(192, 94, 255),
		panel = Color3.fromRGB(40, 16, 78),
		accent = Color3.fromRGB(232, 198, 255),
		silhouette = Color3.fromRGB(15, 7, 28),
		washTransparency = 0.10,
		panelTransparency = 0.04,
		glowTransparency = 0.22,
		stripTransparency = 0.01,
	},
	["Maestro"] = {
		base = Color3.fromRGB(28, 72, 190),
		glow = Color3.fromRGB(72, 142, 255),
		panel = Color3.fromRGB(8, 24, 82),
		accent = Color3.fromRGB(248, 200, 78),
		silhouette = Color3.fromRGB(5, 10, 30),
		washTransparency = 0.10,
		panelTransparency = 0.04,
		glowTransparency = 0.22,
		stripTransparency = 0.01,
	...
	["Immortal"] = {
		base = Color3.fromRGB(112, 214, 255),
		glow = Color3.fromRGB(222, 250, 255),
		panel = Color3.fromRGB(15, 62, 92),
		accent = Color3.fromRGB(198, 245, 255),
		silhouette = Color3.fromRGB(4, 26, 42),
		washTransparency = 0.08,
		panelTransparency = 0.03,
		glowTransparency = 0.20,
		stripTransparency = 0.01,
	},
	["Player of the Year"] = {
		base = Color3.fromRGB(24, 19, 9),
		glow = Color3.fromRGB(255, 207, 58),
		panel = Color3.fromRGB(6, 5, 2),
		accent = Color3.fromRGB(255, 222, 86),
		silhouette = Color3.fromRGB(4, 3, 1),
		washTransparency = 0.06,
...
local function createDisplayCardFace(face, card, incomePerSecond, parent)
	...
	if USE_NEW_CARD_DESIGN then
		...
		if assetId then
			...
			local assetTint = CARD_FRAME_ASSET_TINTS[card.rarity] or CARD_FRAME_ASSET_TINTS["Gold"]
			local tintBase = assetTint.base or rarityColor
			local tintGlow = assetTint.glow or secondaryColor
			local tintPanel = assetTint.panel or darkColor
			local tintAccent = assetTint.accent or trimColor
			local portraitColor = tintAccent
			local portraitDark = assetTint.silhouette or darkColor:Lerp(Color3.fromRGB(0, 0, 0), 0.32)
			...
			local colorWash = make("Frame", {
				AnchorPoint = Vector2.new(0.5, 0),
				BackgroundColor3 = tintBase,
				BackgroundTransparency = assetTint.washTransparency or 0.14,
				BorderSizePixel = 0,
				Position = UDim2.fromScale(0.5, 0.19),
				Size = UDim2.fromScale(0.84, 0.53),
				ZIndex = 2,
			}, frame)
			make("UICorner", { CornerRadius = UDim.new(0.08, 0) }, colorWash)
			make("UIGradient", {
				Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, tintGlow:Lerp(tintBase, 0.32)),
					ColorSequenceKeypoint.new(0.48, tintBase),
					ColorSequenceKeypoint.new(1, tintPanel),
				}),
				Transparency = NumberSequence.new({
			...
			local centralPanel = make("Frame", {
				AnchorPoint = Vector2.new(0.5, 0),
				BackgroundColor3 = tintPanel,
				BackgroundTransparency = assetTint.panelTransparency or 0.06,
				BorderSizePixel = 0,
				Position = UDim2.fromScale(0.5, 0.235),
				Size = UDim2.fromScale(0.70, 0.40),
				ZIndex = 2,
			}, frame)
			make("UICorner", { CornerRadius = UDim.new(0.10, 0) }, centralPanel)
			make("UIStroke", { Color = tintAccent, Thickness = tier >= 3 and 1.8 or 1.4, Transparency = tier >= 3 and 0.08 or 0.18 }, centralPanel)
			make("UIGradient", {
				Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, tintPanel:Lerp(tintBase, 0.30)),
					ColorSequenceKeypoint.new(0.54, tintPanel),
					ColorSequenceKeypoint.new(1, tintPanel:Lerp(Color3.fromRGB(0, 0, 0), 0.25)),
				}),
				Transparency = NumberSequence.new({
			...
			local centralGlow = make("Frame", {
				AnchorPoint = Vector2.new(0.5, 0.5),
				BackgroundColor3 = tintGlow,
				BackgroundTransparency = assetTint.glowTransparency or 0.28,
				BorderSizePixel = 0,
				Position = UDim2.fromScale(0.5, 0.36),
				Size = UDim2.fromScale(0.58, 0.34),
				ZIndex = 2,
			}, frame)
			make("UICorner", { CornerRadius = UDim.new(1, 0) }, centralGlow)
			make("UIGradient", {
				Transparency = NumberSequence.new({
			...
			local heroStrip = make("Frame", {
				AnchorPoint = Vector2.new(0.5, 0),
				BackgroundColor3 = tintPanel:Lerp(tintBase, tier >= 3 and 0.32 or 0.22),
				BackgroundTransparency = assetTint.stripTransparency or 0.03,
				BorderSizePixel = 0,
				Position = UDim2.fromScale(0.5, 0.500),
				Size = UDim2.fromScale(0.80, 0.108),
				ZIndex = 2,
			}, frame)
			make("UICorner", { CornerRadius = UDim.new(0.35, 0) }, heroStrip)
			make("UIStroke", { Color = tintAccent, Thickness = tier >= 4 and 1.8 or 1.4, Transparency = tier >= 3 and 0.04 or 0.14 }, heroStrip)
			make("UIGradient", {
				Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, tintPanel),
					ColorSequenceKeypoint.new(0.50, tintBase),
					ColorSequenceKeypoint.new(1, tintPanel),
				}),
				Rotation = 0,
			}, heroStrip)

			for _, x in ipairs({0.13, 0.845}) do
				make("Frame", {
					BackgroundColor3 = tintAccent,
					BackgroundTransparency = tier >= 3 and 0.06 or 0.18,
					BorderSizePixel = 0,
					Position = UDim2.fromScale(x, 0.265),
					Size = UDim2.fromScale(0.022, 0.31),
					ZIndex = 2,
				}, frame)
			end
			...
			if tier == 4 then
				make("Frame", {
					...
					BorderSizePixel = 0,
					Position = UDim2.fromScale(0.5, 0.220),
					Size = UDim2.fromScale(0.46, 0.010),
					ZIndex = 2,
				}, frame)
			elseif tier == 5 then
				for _, y in ipairs({0.250, 0.575}) do
					make("Frame", {
						AnchorPoint = Vector2.new(0.5, 0),
						BackgroundColor3 = Color3.fromRGB(245, 255, 255),
						BackgroundTransparency = 0.22,
						BorderSizePixel = 0,
						Position = UDim2.fromScale(0.5, y),
						Size = UDim2.fromScale(0.52, 0.010),
						ZIndex = 2,
					}, frame)
				end
			elseif tier == 6 then
				...
				make("Frame", {
					...
					BackgroundTransparency = 0.08,
					BorderSizePixel = 0,
					Position = UDim2.fromScale(0.5, crownY + 0.052),
					Size = UDim2.fromScale(0.32, 0.016),
					ZIndex = 2,
				}, frame)
				for index = 1, 5 do
					make("Frame", {
						...
						BackgroundColor3 = tintAccent,
						BackgroundTransparency = index == 3 and 0.02 or 0.14,
						BorderSizePixel = 0,
						Position = UDim2.fromScale(0.34 + (index - 1) * 0.08, crownY + 0.052),
						Size = UDim2.fromScale(0.020, index == 3 and 0.064 or 0.042),
						ZIndex = 2,
					}, frame)
				end
			end
			...
			local portraitGlow = make("Frame", {
				...
				BackgroundTransparency = assetTint.glowTransparency or (tier >= 3 and 0.28 or 0.38),
				BorderSizePixel = 0,
				Position = UDim2.fromScale(0.5, 0.405),
				Size = UDim2.fromScale(0.50, 0.31),
				ZIndex = 2,
			}, frame)
