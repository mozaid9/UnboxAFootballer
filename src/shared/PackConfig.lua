...
PackConfig.ShopOrder = {
	...
	{
		id = "StarPickPack",
		displayName = "87+ Star Pick",
		description = "Choose 1 of 3. Every option is guaranteed 87+ rated.",
		cost = 0,
		futureCost = 15000000,
		shopBuyable = true,
		cardCount = 1,
	...
	{
		id = "PrimeStarPickPack",
		displayName = "90+ Prime Pick",
		description = "Choose 1 of 3. Every option is guaranteed 90+ rated.",
		cost = 0,
		futureCost = 60000000,
		shopBuyable = true,
		cardCount = 1,
	...
	{
		id = "LegendPickPack",
		displayName = "93+ Legend Pick",
		description = "Choose 1 of 3. Every option is a guaranteed 93+ legend.",
		cost = 0,
		futureCost = 175000000,
		shopBuyable = true,
		cardCount = 1,
		hitsRequired = 84,
		padWeight = 0,
		color = Color3.fromRGB(255, 80, 80),
		tierWeights = { 0, 0, 0, 0, 26, 52, 22 },
		playerPick = {
			optionCount = 3,
			minPowerScore = 93,
		},
