...
Constants.Quests = {
	...
	},
	{
		id = "claim_free_pack",
		title = "Free Pack Run",
		description = "Claim the free pack when it is ready.",
		action = "claimFreePack",
		target = 1,
		rewardFans = 10000,
		rewardGems = 1,
	},
	...
	},
	{
		id = "open_10_packs",
		title = "Pack Marathon",
		description = "Open 10 packs in one day.",
		action = "openPack",
		target = 10,
		rewardFans = 50000,
		rewardGems = 2,
	...
	{
		id = "collect_20_players",
		title = "Scout Report",
		description = "Add 20 players to your club.",
		action = "collectCard",
		target = 20,
		rewardFans = 75000,
		rewardGems = 2,
	...
	{
		id = "sell_12_players",
		title = "Squad Clearout",
		description = "Sell 12 stored players.",
		action = "sellCard",
		target = 12,
		rewardFans = 60000,
		rewardGems = 2,
	...
	{
		id = "buy_3_shop_packs",
		title = "Transfer Spree",
		description = "Buy 3 packs from the shop.",
		action = "buyPack",
		target = 3,
		rewardGems = 2,
		rewardPackId = "PremiumPack",
	},
}
...
Constants.FanZone = {
	...
	MaxStadiumVisitors = 10,
	VisitorRouteChance = 0.40,
	FoodStopChance = 0.35,
	NpcWalkSpeed = 13,
