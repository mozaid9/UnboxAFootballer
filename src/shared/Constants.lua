...
Constants.RarityStyles = {
	["Gold"] = {
		...
		secondary = Color3.fromRGB(116, 78, 12),
		dark = Color3.fromRGB(28, 22, 10),
		trim = Color3.fromRGB(235, 178, 44),
	...
	["Rare Gold"] = {
		...
		secondary = Color3.fromRGB(222, 92, 10),
		dark = Color3.fromRGB(34, 15, 4),
	...
	["Talisman"] = {
		...
		secondary = Color3.fromRGB(126, 12, 18),
		dark = Color3.fromRGB(26, 4, 8),
		trim = Color3.fromRGB(255, 132, 78),
	...
	["Maestro"] = {
		...
		secondary = Color3.fromRGB(82, 24, 156),
		dark = Color3.fromRGB(14, 8, 34),
		trim = Color3.fromRGB(232, 178, 255),
	...
	["Immortal"] = {
		...
		secondary = Color3.fromRGB(112, 186, 255),
		dark = Color3.fromRGB(13, 20, 34),
		trim = Color3.fromRGB(245, 255, 255),
		text = Color3.fromRGB(245, 252, 255),
		glow = Color3.fromRGB(218, 250, 255),
	},
	["Player of the Year"] = {
		label = "POTY",
		primary = Color3.fromRGB(255, 218, 76),
		secondary = Color3.fromRGB(5, 5, 6),
		dark = Color3.fromRGB(1, 1, 3),
		trim = Color3.fromRGB(255, 235, 126),
		text = Color3.fromRGB(255, 246, 214),
