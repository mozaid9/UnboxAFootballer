...
local INVENTORY_SKINS = {
	["Gold"] = {
		...
		bgC = Color3.fromRGB(72, 40, 6),
		shine = Color3.fromRGB(255, 186, 58),
	...
	["Rare Gold"] = {
		...
		bgC = Color3.fromRGB(46, 10, 3),
		shine = Color3.fromRGB(255, 114, 34),
		trim = Color3.fromRGB(255, 160, 46),
		glow = Color3.fromRGB(255, 112, 28),
		text = Color3.fromRGB(255, 242, 222),
		meta = Color3.fromRGB(255, 178, 112),
		fansBg = Color3.fromRGB(48, 11, 3),
		badgeBg = Color3.fromRGB(255, 150, 44),
		badgeText = Color3.fromRGB(42, 12, 2),
		icon = "R",
	},
	["Premium Gold"] = {
		bgA = Color3.fromRGB(172, 108, 12),
		bgB = Color3.fromRGB(255, 204, 58),
		bgC = Color3.fromRGB(84, 48, 4),
		shine = Color3.fromRGB(255, 244, 146),
		trim = Color3.fromRGB(255, 236, 116),
		glow = Color3.fromRGB(255, 234, 118),
		text = Color3.fromRGB(36, 22, 4),
		meta = Color3.fromRGB(86, 56, 12),
		fansBg = Color3.fromRGB(62, 38, 4),
		badgeBg = Color3.fromRGB(255, 236, 116),
		badgeText = Color3.fromRGB(24, 16, 3),
		icon = "P",
		baseScale = 1.035,
		hoverScale = 1.07,
		outerGlow = true,
	...
	["Talisman"] = {
		...
		bgC = Color3.fromRGB(16, 4, 36),
		shine = Color3.fromRGB(202, 86, 255),
		trim = Color3.fromRGB(202, 84, 255),
		glow = Color3.fromRGB(214, 116, 255),
		text = Color3.fromRGB(248, 230, 255),
		meta = Color3.fromRGB(218, 170, 255),
		fansBg = Color3.fromRGB(28, 7, 56),
		badgeBg = Color3.fromRGB(206, 92, 255),
		badgeText = Color3.fromRGB(26, 6, 48),
		icon = "T",
	},
	["Maestro"] = {
		bgA = Color3.fromRGB(5, 22, 86),
		bgB = Color3.fromRGB(26, 86, 212),
		bgC = Color3.fromRGB(3, 8, 34),
		shine = Color3.fromRGB(74, 142, 255),
		trim = Color3.fromRGB(255, 204, 70),
		glow = Color3.fromRGB(88, 154, 255),
		text = Color3.fromRGB(238, 246, 255),
		meta = Color3.fromRGB(174, 202, 255),
		fansBg = Color3.fromRGB(4, 16, 54),
		badgeBg = Color3.fromRGB(255, 204, 70),
		badgeText = Color3.fromRGB(5, 18, 62),
		icon = "M",
	},
	["Immortal"] = {
		bgA = Color3.fromRGB(24, 118, 170),
		bgB = Color3.fromRGB(116, 218, 255),
		bgC = Color3.fromRGB(8, 48, 80),
		shine = Color3.fromRGB(232, 255, 255),
		trim = Color3.fromRGB(220, 252, 255),
		glow = Color3.fromRGB(210, 248, 255),
		text = Color3.fromRGB(245, 255, 255),
		meta = Color3.fromRGB(194, 238, 255),
		fansBg = Color3.fromRGB(8, 42, 66),
		badgeBg = Color3.fromRGB(226, 254, 255),
		badgeText = Color3.fromRGB(8, 34, 52),
		icon = "I",
		outerGlow = true,
		shineOverlay = true,
	},
